...
import { Fulldetail , Fullheight , Fullfornt , Fullback , CardBackH2 , CardBackLocation ,
     Fullmap , Fullhead , Fullbody , CardStar , AbstractHidden} from '../style'
        ...
        return (
            <Fullheight className="card__active">
                ...
                <Fullback className="card_back">
                    ...
                    <Fullbody>
                        <AbstractHidden className="abstract">
                            <ul className="abstract_face">
                                <li style={{backgroundImage: 'url('+ face1 +')'}}></li>
                                <li style={{backgroundImage: 'url('+ face2 +')'}}></li>
                            </ul>
